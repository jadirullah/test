<html>
    <head>
        <title>CodeIgniter : Login Google via Oauth 2.0</title>
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/style-api.css">
        <link rel="stylesheet" media="screen and (max-width: 1200px) and (min-width: 0px)" type="text/css" href="<?php echo base_url(); ?>assets/css/styleresponsive1.css">
        <link rel="stylesheet" media="screen and (max-width: 600px) and (min-width: 0px)" type="text/css" href="<?php echo base_url(); ?>assets/css/styleresponsive2.css">
        ...
        <div id="main">
            <div id="envelope">
                <?php if (isset($authUrl)) { ?>
                    ...
                    <hr>
                    <div id="content">
                        <center><a href="<?php echo $authUrl; ?>"><img id="google_signin" src="<?php echo base_url(); ?>assets/images/sign-in-button-google.png" width="100%" ></a></center>
                    </div>
                <?php } else { ?>
                    <header id="info">
