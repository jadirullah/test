    ...
    <body>
        <section id="wrapper">
            ...
            <div style="margin-left:160px;">
                ...
                echo form_open_multipart('test/act_clockin_late',$attributes);?>
                <table width="100%">
                    <tr>
                    ...
                    <tr>
                        <td>Late Category</td><td>:</td>
                        <td>
                            <select name="ctg_id" required>
                   ...
                   <tr>
                        <td>Reason Late</td><td>:</td>
                        <td><textarea name="reason_late" required></textarea></td>
                   </tr> 
                   <tr>
                        <td>Lampiran Image</td><td>:</td>
                        <td><input type="file" name="userfile1" size="20" required /></td>
                   </tr>
                   <tr>
                        <td>Lampiran Image2</td><td>:</td>
                        <td><input type="file" name="userfile2" size="20"  required/></td>
                   </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3"><input type="submit" value="Clock IN"></td>
                    </tr>
                </table>
                <?php 
                echo form_close();
                //jika tidak telat
                    ...
                    $attributes = array('class' => 'formpeta');
                    echo form_open_multipart('test/act_clockin',$attributes);
                ?>
                <table width="100%">
                    <tr>
                        <td>Your Email</td><td>:</td>
