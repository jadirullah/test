...
<?php
	...
	if(!empty($_GET["push"])) {	
		$gcmRegID  = "APA91bEm7Q8OdUBL94-UfIiUc2C-1v4CdCsORYaLo-zg9fh0fLCAFHFeyWOnzNuN-95mjqPU19Nd6-BlZFRU1n6z4f6z23Gp1HlDugy2oJdXP9-pGdrGEwW4254VlkZHjeh-W_s4wBWl";//file_get_contents("GCMRegId.txt");
...
<html>
	...
	<body>
		...
		<form method="post" action="../controllers/Gcm.php/?push=true" onsubmit="return checkTextAreaLen()">					                                                      
