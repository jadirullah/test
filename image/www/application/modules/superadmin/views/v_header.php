            ...
            <div class="subnavbar-inner">
                <div class="container">
                    <ul class="mainnav">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i><img width="20" height="20" style="margin-left:-5px;" src="<?php echo base_url(); ?>assets/img/icon/user.png"></i><span>Users Management</span> <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="<?php echo base_url(); ?>index.php/superadmin/manage_user">Users</a></li>
                              <li><a href="<?php echo base_url(); ?>index.php/superadmin/manage_employed">Employed</a></li>
                            </ul>
                        </li>

<li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i><img width="25" height="25" style="margin-left:-5px;" src="<?php echo base_url(); ?>assets/img/icon/product.png"></i><span>Attendance Management</span> <b class="caret"></b></a>
  <ul class="dropdown-menu">
    <li><a href="<?php echo base_url(); ?>index.php/superadmin/manage_attandance">List Attendance</a></li>
  </ul>
</li>
