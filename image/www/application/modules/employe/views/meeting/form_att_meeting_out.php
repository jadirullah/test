                                        ...
                                        <div class="top-search">
                                            <article align="center">
                                                <span id="button" style="margin:auto;">
                                                    <a href="#" id="ahref" class="btn btn-info btn-large">Clock Out Meeting</a>
                                                </span><br>
                                                <span id="status"></span>
                                                <br>
                                            ...
                                            <?php                                             
								                    ...
								                    echo form_open_multipart('employe/meeting/act_clockout',$attributes);								        
                                            ?>
                                                    ...
                                                    <div class="control-group">                     
                                                        ...
                                                        <div class="controls">                                                          
                                                            <select id='events' name="reason_meeting" required>
